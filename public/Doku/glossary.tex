...
\newglossaryentry{MED}{
  ...
  firstplural={Microsoft Excel-Dateien (\glsentryplural{MED})}
}
\newglossaryentry{IDP}{
  name={IdP},
  description={Identity Provider, einen Dienst, der digitale Identitäten speichert und verwaltet},
...
\newglossaryentry{MERN}{
  name={MERN},
  description={Eine Full-Stack Lösung, welche aus den Komponenten: \gl{MongoDB}, \gl{express}, \gl{React} und \gl{nodejs}. besteht },
  first={\textbf{M}ongoDB, \textbf{E}xpress, \textbf{R}eact, \textbf{N}ode (MERN)},
}
...
\newglossaryentry{JSdoc}{
  name={JSdoc},
  description={eine Auszeichnungssprache, die zum Annotieren von \gl{JS} Quellcodedateien verwendet wird, \ext{https://jsdoc.app/} }
}
