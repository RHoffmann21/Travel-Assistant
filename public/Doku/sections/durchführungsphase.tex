...
Als Vorgehensmodell wurde das Kanbanboard, da dieses hauptsächlich im Softwareentwicklungsteam verwendet wird. Die Anforderungen wurden in Aufgaben(Tasks) unterteilt und grob priorisiert, dazu wurde das Online-Webtool \gl{miro} zur Visualisierung der Tasks und deren Status verwendet.
