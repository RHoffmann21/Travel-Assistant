...
Nachdem die Berechnungslogik implementiert wurde, muss diese aufgrund des ausdrücklichen Kundenwunschs ausgiebig getestet werden. Hierfür wurde \gl{jest} benutzt. Ein Auszug eines Unittest ist im Anhang unter \sct{sec:Anhang:Unittest-Ausschnitt}{Unittest-Ausschnitt} zu finden.
