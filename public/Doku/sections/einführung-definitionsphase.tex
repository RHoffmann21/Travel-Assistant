...
Die \gl{MED} wurde ursprünglich von einem externen Dienstleister im Auftrag der DTS Systeme GmbH erstellt. Seitdem wurde sie nicht mehr weiterentwickelt oder angepasst, weshalb einige ursprüngliche Funktionen und Felder nicht mehr benötigt werden.

\subsection{Projektbeschreibung}
\label{sec:Einführung-Definitionsphase:Projektbeschreibung}

Die in der Ausgangssituation beschriebene \gl{MED} soll nun abgelöst werden.
...
\begin{enumerate}
    ...
    \item \textbf{Integration des Hauseigenen \gl{IDP} \footnote{engl. Identitätsanbieter, bezeichnet ein zentrales Zugangssystem zu den Leistungen von Diensteanbietern, bei dem sich die Nutzer anmelden können.}}\\
