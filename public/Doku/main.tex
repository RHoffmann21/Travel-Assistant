...
\usepackage[a4paper, left=3.5cm, top=3.5cm, bottom=3cm, right=3cm]{geometry}
...
\input{attachments/sollistvergleich}
\pagebreak

\input{attachments/prozessreisekostenabrechnungalt}
\pagebreak
...
\input{attachments/idplogin}

\input{attachments/kanbanboard}
\pagebreak
...
\input{attachments/sketches}

\input{attachments/projektantrag}
